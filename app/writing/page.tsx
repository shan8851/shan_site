    ...
    <div className="max-w-3xl space-y-6">
      <header className="space-y-2">
        <div className="inline-flex items-center gap-2 rounded-full border border-border/70 bg-surface/50 px-3 py-1 text-xs text-textSecondary">
          ...
          <span className="text-textTertiary">now-ish™</span>
        </div>
      ...
      <section className="rounded-2xl border border-border/80 bg-surface/50 p-5 stitch">
        ...
        <p className="mt-2 text-textSecondary leading-relaxed">
          It’s no longer coming soon. It’s coming… continuously. I’m still
          negotiating with my future self about:
        </p>
        <ul className="mt-3 space-y-2 text-textSecondary">
          <li>• categories vs. tags (tags are winning)</li>
          <li>• whether everything needs an opinion (it does, unfortunately)</li>
          <li>• how many posts before I’m allowed to add RSS (TBD)</li>
        </ul>
      ...
      <section className="rounded-2xl border border-border/80 bg-surface/50 p-5">
        ...
        <div className="mt-3 grid gap-3 md:grid-cols-2">
          <Topic
            ...
            note="Boring reliability, graceful failure, and how not to ship footguns."
          />
          <Topic
            title="On-chain rails"
            note="Stablecoins, settlement, and why product constraints are real."
          />
          <Topic
            title="Tooling"
            note="Agents, automation, and time-saving glue code."
          />
          <Topic
            title="Builder notes"
            note="Small systems that compound over months."
          />
        </div>
      </section>
